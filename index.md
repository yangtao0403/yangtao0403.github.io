...
I received bachelor's degree in Electronics and Information Engineering from Beihang University, China, in 2003. After that, I spent 14 years studying and working overseas, during which I received Ph.D. degree in Telecommunications Engineering from the University of New South Wales (UNSW), Sydney, NSW, Australia and worked as a Lecturer/Senior Lecturer (permanent position), PhD supervisor，within the University of Technology Sydney, Australia. I returned to Beihang University, China, in 2019. To date, I have authored over 100 research articles in IEEE journals and conferences, most of them are published in IEEE transactions on Wireless Communications, Communications, Information Theory, Signal Processing, JSAC, Vehicular Technology and etc. I was holding an Australian Research Council Discovery Early Career Research Award (DECRA) Fellowship (Success rate 11.7%). I have been continuously serving as TPC member of the IEEE ICC, Globecom, WCNC, ICCC and etc., reviewer of ARC discovery projects, National natural science foundation of China and IEEE journals. I was a recipient of the Australian Postgraduate Award, the NICTA Research Project Award. 

My research aims at addressing the key issues of 5G/6G wireless and satellite internet, such as massive connectivity, low-latency, high data rate and reliability, high mobility, security. My expertises include: 
1) Coding techniques: polar，LDPC and lattice codes, dirty paper coding, distributed source coding, lossy data compression (vector quantization) coding, physical-layer network coding and etc.;
2) Multiuser communication: advanced detection and channel estimation for multiple access channel, precoding for broadcast channel;
3) MIMO: massive MIMO, cell-free MIMO, beamforming design for satellite systems;
